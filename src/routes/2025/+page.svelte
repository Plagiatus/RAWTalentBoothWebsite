<script>
    import Landing from "$lib/cmp/Sections/2025/Landing.svelte";
    import GalleryPage from "$lib/cmp/Sections/GalleryPage.svelte";
    import Booth from "$lib/cmp/Sections/Booth.svelte";
